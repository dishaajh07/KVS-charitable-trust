    ...
    <section className={styles.supportPrograms}>
      <div className={styles.container}>
        ...
        <p className={styles.description}>
         Together, we can write more stories of transformation. Every contribution,
every volunteer hour, and every act of kindness creates ripples of hope that
reach far beyond what we can imagine.
        </p>
